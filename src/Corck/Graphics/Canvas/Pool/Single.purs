...
import Corck.Graphics.Canvas.CanvasElement (Dimensions)
import Corck.Graphics.Canvas.CanvasElement (new, setLogicalDimensions, setPhysicalDimensions, toHTMLCanvasElement) as CanvasElement
