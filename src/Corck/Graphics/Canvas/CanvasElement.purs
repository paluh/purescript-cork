module Corck.Graphics.Canvas.CanvasElement where
...
minCanvasPhysicalDimensions ∷ CanvasElement → Geometry.Plane.Dimensions Units.Pixel → Effect Unit
minCanvasPhysicalDimensions canvasElement dimensions =  do
  let
